        ...
        ListHeaderComponent={
          <View style={styles.headerWrap}>
            <RiderScreenHeader
              ...
              subtitle={copy.available.subtitle}
          ...
          <Pressable style={styles.card} onPress={() => router.push(`/orders/${item.id}`)}>
            <View style={styles.row}>
              ...
              <View style={styles.readyChip}>
                <Text style={styles.readyChipText}>Ready now</Text>
              </View>
            </View>
            <Text style={styles.name}>{item.restaurant?.name ?? copy.common.restaurant}</Text>
            <Text style={styles.metaStrong}>
              {item.customer?.name ?? copy.common.customer}
            </Text>
...
const styles = StyleSheet.create({
  ...
  readyChipText: { fontSize: 12, fontWeight: "800", color: palette.secondary },
